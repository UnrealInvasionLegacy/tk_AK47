class AK47Proj extends Projectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	{
	    bingo = Spawn(class'tk_AK47.AK47KaBoom',,,HitLocation + HitNormal*16,rotator(HitNormal));
...
defaultproperties
{
     ...
     MyDamageType=Class'tk_AK47.DamTypeAK47Dam'
